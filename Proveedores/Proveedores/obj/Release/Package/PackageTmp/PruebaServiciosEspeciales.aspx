        ...
        <div class="col-lg-8" style="float:left">
            <div class="ibox float-e-margins">
                <div class="auto-style13">
                    ...
                    <br />
                    <input type="text" class="auto-style22" style="text-align:left"/>
                    <br />
                </div>
            </div>
        </div>
             ...
             <div class="ibox float-e-margins">
                 <div class="auto-style9">
                     <div ibox-tools class="auto-style16" style="text-align:center">
                         ...
                         <div><input type="text" placeholder="Cantidad" class="auto-style17"/><input type="text" placeholder="Peso " class="auto-style14"/></div><br /><br /><br />
                         <div><input type="text" placeholder="Fecha " class="auto-style18" style="float:right"/><input type="text" placeholder="Hora" class="auto-style18" style="float:left"/></div ><br />
                         <br />
                         <br />
                         <div class="text-left">
                             <label class="auto-style20" style="text-align:center"> 
                             <div class="text-center" style="text-align:center"><strong>Ayudante :</strong> 
                         <input type="radio"  id="optionsRadios12" name="optionsRadios23" onclick="MostrarAyudantes()" checked="checked"/> Si&nbsp;&nbsp;&nbsp; 
                         <input type="radio" value="option2" id="optionsRadios23" name="optionsRadios23" class="auto-style8" onclick="OcultarAyudantes()" /><span class="auto-style8"> No</span></div>
                         </div>
                         <input type="text" id="NumeroAyudantes" placeholder="Cuantos" class="form-control" /><br />
                         <label class="auto-style20" style="text-align:center"> <strong>Escolta</strong><span class="auto-style8"><strong> :&nbsp;</strong></span><span class="auto-style11">&nbsp;&nbsp;</span> 
